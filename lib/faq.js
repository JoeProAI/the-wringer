...
export const FAQS = [
  ...
  },
  {
    ...
    a: "Yes. Work orders are sent to the audit model or the sandbox only when you run them, and nothing is stored on our side. There is no database of your prompts.",
  },
  {
