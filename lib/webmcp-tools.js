...
export const createWebMcpTools = (actions) => [
  ...
  },
  {
    ...
    description: "Stage the paid $1 Audit for the current work order. This never charges, creates checkout, redirects, or submits payment. The user must confirm with the visible Audit button.",
    inputSchema: EMPTY_SCHEMA,
  ...
  },
  {
    ...
    description: "Stage a paid MECHA full case with the selected strategy and agent count. This never charges, creates checkout, redirects, or submits payment. The user must confirm with the visible MECHA button.",
