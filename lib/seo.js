...
// defaults to www and an apex value in the SITE_URL env var is normalized
// to www. Set SITE_URL env only if you host elsewhere on purpose.

export const SITE_URL = (process.env.SITE_URL || "https://www.thewringer.ai")
  .replace(/\/+$/, "")
  .replace(/^https?:\/\/thewringer\.ai(?=\/|$)/, "https://www.thewringer.ai");
