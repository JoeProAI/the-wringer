...
report = {
    ...
    "total_input_tokens": run_data.get("total_input_tokens", sum(c["input_tokens"] for c in candidates)),
    "total_output_tokens": run_data.get("total_output_tokens", sum(c["output_tokens"] for c in candidates)),
    "artifacts": artifacts,
}
