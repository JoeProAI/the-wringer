...
payload = json.dumps({
    ...
    "imageOptions": {
        "source": "aiGenerated",
        "model": "gpt-image-2",
        "style": "Dark trial-room editorial. Hard light, high detail, physical evidence and instruments. No stock-photo smiles, no purple gradients, no rounded SaaS cards, no emoji, no cartoon mascots."
    }
}).encode("utf-8")
...
try:
    ...
    # Poll for completion (max 6 min - GPT Image 2 needs longer than cheap models)
    gamma_url = None
    export_url = None
    for _ in range(72):
        time.sleep(5)
